		...
		<Form.Root>
			{#if testResult?.kind?.value?.output && testResult.kind.case == 'warp'}
				...
				<Form.Fieldset>
					...
					<Form.Description
						>Total Bytes: {getTotalBytes.value} {getTotalBytes.unit}</Form.Description
					>
					...
					<Form.Description
						>Bytes - Fastest/sec: {getFastest.value} {getFastest.unit}/s</Form.Description
					>
					<Form.Description
						>Bytes - Median/sec: {getMedian.value} {getMedian.unit}/s</Form.Description
					>
					<Form.Description
						>Bytes - Slowest/sec: {getSlowest.value} {getSlowest.unit}/s</Form.Description
					>
					<Form.Description
						>Objects - Fastest/sec: {getOutput?.objects?.fastestPerSecond}</Form.Description
					>
					<Form.Description
						>Objects - Median/sec: {getOutput?.objects?.medianPerSecond}</Form.Description
					>
					<Form.Description
						>Objects - Slowest/sec: {getOutput?.objects?.slowestPerSecond}</Form.Description
					>
				</Form.Fieldset>
				<Form.Fieldset>
					...
					<Form.Description
						>Total Bytes: {putTotalBytes.value} {putTotalBytes.unit}</Form.Description
					>
					...
					<Form.Description
						>Bytes - Fastest/sec: {putFastest.value} {putFastest.unit}/s</Form.Description
					>
					<Form.Description
						>Bytes - Median/sec: {putMedian.value} {putMedian.unit}/s</Form.Description
					>
					<Form.Description
						>Bytes - Slowest/sec: {putSlowest.value} {putSlowest.unit}/s</Form.Description
					>
					<Form.Description
						>Objects - Fastest/sec: {putOutput?.objects?.fastestPerSecond}</Form.Description
					>
					<Form.Description
						>Objects - Median/sec: {putOutput?.objects?.medianPerSecond}</Form.Description
					>
					<Form.Description
						>Objects - Slowest/sec: {putOutput?.objects?.slowestPerSecond}</Form.Description
					>
				</Form.Fieldset>
				<Form.Fieldset>
					...
					<Form.Description
						>Total Bytes: {deleteTotalBytes.value} {deleteTotalBytes.unit}</Form.Description
					>
					...
					<Form.Description
						>Bytes - Fastest/sec: {deleteFastest.value} {deleteFastest.unit}/s</Form.Description
					>
					<Form.Description
						>Bytes - Median/sec: {deleteMedian.value} {deleteMedian.unit}/s</Form.Description
					>
					<Form.Description
						>Bytes - Slowest/sec: {deleteSlowest.value} {deleteSlowest.unit}/s</Form.Description
					>
					<Form.Description
						>Objects - Fastest/sec: {deleteOutput?.objects?.fastestPerSecond}</Form.Description
					>
					<Form.Description
						>Objects - Median/sec: {deleteOutput?.objects?.medianPerSecond}</Form.Description
					>
					<Form.Description
						>Objects - Slowest/sec: {deleteOutput?.objects?.slowestPerSecond}</Form.Description
					>
				</Form.Fieldset>
			{:else}
