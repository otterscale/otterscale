...
import (
	...
	"github.com/openhdc/openhdc/connectors/oracle/client"
...
var (
	...
	// read
	connString = flag.String("connection_string", "", "connection string, such as 'oracle://openhdc:secret@or.example.com:1521/<owner>'")
	namespace  = flag.String("namespace", "", "namespace of database")
