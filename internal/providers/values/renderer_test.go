...
const wantFull = `# Generated by OtterScale v1.5.0 for cluster "cluster". Do not edit; re-issue instead.
repositories:
  modules:
    url: oci://192.168.196.222:8443/modules
    interval: 1h
    certSecretRef: otterscale-ca
    labels:
...
const wantWithoutTrustedCA = `# Generated by OtterScale v1.5.0 for cluster "cluster". Do not edit; re-issue instead.
repositories:
  modules:
    url: oci://192.168.196.222:8443/modules
    interval: 1h
