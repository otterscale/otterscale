...
// Update performs a full-replacement update (PUT) for the given resource.
// The manifest is forwarded to the cluster unchanged; the caller must
// supply any server-required fields (such as metadata.resourceVersion).
