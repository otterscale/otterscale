...
func (tu *TeamUpdate) SetOrganizationID(id string) *TeamUpdate {
	tu.mutation.SetOrganizationID(id)
	return tu
}

// SetOrganization sets the "organization" edge to the Organization entity.
func (tu *TeamUpdate) SetOrganization(o *Organization) *TeamUpdate {
...
func (tu *TeamUpdate) ClearOrganization() *TeamUpdate {
...
func (tu *TeamUpdate) check() error {
	if tu.mutation.OrganizationCleared() && len(tu.mutation.OrganizationIDs()) > 0 {
		return errors.New(`ent: clearing a required unique edge "Team.organization"`)
	}
	return nil
}
...
func (tu *TeamUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if tu.mutation.OrganizationCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   team.OrganizationTable,
			Columns: []string{team.OrganizationColumn},
			Bidi:    false,
...
// SetOrganizationID sets the "organization" edge to the Organization entity by ID.
func (tuo *TeamUpdateOne) SetOrganizationID(id string) *TeamUpdateOne {
	tuo.mutation.SetOrganizationID(id)
	return tuo
}

// SetOrganization sets the "organization" edge to the Organization entity.
func (tuo *TeamUpdateOne) SetOrganization(o *Organization) *TeamUpdateOne {
...
// ClearOrganization clears the "organization" edge to the Organization entity.
func (tuo *TeamUpdateOne) ClearOrganization() *TeamUpdateOne {
...
func (tuo *TeamUpdateOne) check() error {
	if tuo.mutation.OrganizationCleared() && len(tuo.mutation.OrganizationIDs()) > 0 {
		return errors.New(`ent: clearing a required unique edge "Team.organization"`)
	}
	return nil
}
