...
func (tc *TeamCreate) SetOrganizationID(id string) *TeamCreate {
	tc.mutation.SetOrganizationID(id)
	return tc
}

// SetOrganization sets the "organization" edge to the Organization entity.
func (tc *TeamCreate) SetOrganization(o *Organization) *TeamCreate {
...
func (tc *TeamCreate) check() error {
	...
	if len(tc.mutation.OrganizationIDs()) == 0 {
		return &ValidationError{Name: "organization", err: errors.New(`ent: missing required edge "Team.organization"`)}
	}
	return nil
}
