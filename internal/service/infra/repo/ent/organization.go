...
func (*Organization) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case organization.FieldID, organization.FieldName, organization.FieldSlug, organization.FieldLogo, organization.FieldCreatedAt, organization.FieldMetadata:
	...
	for i := range columns {
		...
		case organization.FieldCreatedAt:
			if value, ok := values[i].(*sql.NullString); !ok {
				...
				o.CreatedAt = value.String
			}
		case organization.FieldMetadata:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field metadata", values[i])
			} else if value.Valid {
				o.Metadata = value.String
			}
		default:
...
func (o *Organization) QueryTeams() *TeamQuery {
	return NewOrganizationClient(o.config).QueryTeams(o)
}
...
func (o *Organization) QueryInvitations() *InvitationQuery {
...
func (o *Organization) String() string {
	...
	builder.WriteString(o.CreatedAt)
	builder.WriteString(", ")
	builder.WriteString("metadata=")
	builder.WriteString(o.Metadata)
	builder.WriteByte(')')
