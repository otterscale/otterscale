...
func (s *InstanceService) ListVirtualMachines(ctx context.Context, req *pb.ListVirtualMachinesRequest) (*pb.ListVirtualMachinesResponse, error) {
	vms, err := s.instance.ListVirtualMachines(ctx, req.GetScope(), req.GetNamespace())
	if err != nil {
		return nil, err
	}
	its, err := s.instance.ListInstanceTypes(ctx, req.GetScope(), req.GetNamespace(), true)
	if err != nil {
		return nil, err
	}
...
func (s *InstanceService) GetVirtualMachine(ctx context.Context, req *pb.GetVirtualMachineRequest) (*pb.VirtualMachine, error) {
	vm, err := s.instance.GetVirtualMachine(ctx, req.GetScope(), req.GetNamespace(), req.GetName())
	if err != nil {
		return nil, err
	}
	its, err := s.instance.ListInstanceTypes(ctx, req.GetScope(), req.GetNamespace(), true)
...
func (s *InstanceService) CreateVirtualMachine(ctx context.Context, req *pb.CreateVirtualMachineRequest) (*pb.VirtualMachine, error) {
	vm, err := s.instance.CreateVirtualMachine(ctx, req.GetScope(), req.GetNamespace(), req.GetName(), req.GetInstanceTypeName(), req.GetBootDataVolumeName(), req.GetStartupScript())
	if err != nil {
		return nil, err
	}
	its, err := s.instance.ListInstanceTypes(ctx, req.GetScope(), req.GetNamespace(), true)
...
func (s *InstanceService) DeleteVirtualMachine(ctx context.Context, req *pb.DeleteVirtualMachineRequest) (*emptypb.Empty, error) {
	if err := s.instance.DeleteVirtualMachine(ctx, req.GetScope(), req.GetNamespace(), req.GetName()); err != nil {
		return nil, err
	}
	resp := &emptypb.Empty{}
	return resp, nil
...
func (s *InstanceService) AttachVirtualMachineDisk(ctx context.Context, req *pb.AttachVirtualMachineDiskRequest) (*pb.VirtualMachine_Disk, error) {
	disk, volume, err := s.instance.AttachVirtualMachineDisk(ctx, req.GetScope(), req.GetNamespace(), req.GetName(), req.GetDataVolumeName())
	if err != nil {
		return nil, err
	}
...
func (s *InstanceService) DetachVirtualMachineDisk(ctx context.Context, req *pb.DetachVirtualMachineDiskRequest) (*emptypb.Empty, error) {
	if err := s.instance.DetachVirtualMachineDisk(ctx, req.GetScope(), req.GetNamespace(), req.GetName(), req.GetDataVolumeName()); err != nil {
		return nil, err
	}
	resp := &emptypb.Empty{}
	return resp, nil
...
func (s *InstanceService) CreateVirtualMachineClone(ctx context.Context, req *pb.CreateVirtualMachineCloneRequest) (*pb.VirtualMachine_Clone, error) {
	clone, err := s.instance.CreateVirtualMachineClone(ctx, req.GetScope(), req.GetNamespace(), req.GetName(), req.GetSourceVirtualMachineName(), req.GetTargetVirtualMachineName())
	if err != nil {
		return nil, err
	}
...
func (s *InstanceService) DeleteVirtualMachineClone(ctx context.Context, req *pb.DeleteVirtualMachineCloneRequest) (*emptypb.Empty, error) {
	if err := s.instance.DeleteVirtualMachineClone(ctx, req.GetScope(), req.GetNamespace(), req.GetName()); err != nil {
		return nil, err
	}
	resp := &emptypb.Empty{}
	return resp, nil
...
func (s *InstanceService) CreateVirtualMachineSnapshot(ctx context.Context, req *pb.CreateVirtualMachineSnapshotRequest) (*pb.VirtualMachine_Snapshot, error) {
	snapshot, err := s.instance.CreateVirtualMachineSnapshot(ctx, req.GetScope(), req.GetNamespace(), req.GetName(), req.GetVirtualMachineName())
	if err != nil {
		return nil, err
	}
...
func (s *InstanceService) DeleteVirtualMachineSnapshot(ctx context.Context, req *pb.DeleteVirtualMachineSnapshotRequest) (*emptypb.Empty, error) {
	if err := s.instance.DeleteVirtualMachineSnapshot(ctx, req.GetScope(), req.GetNamespace(), req.GetName()); err != nil {
		return nil, err
	}
	resp := &emptypb.Empty{}
	return resp, nil
...
func (s *InstanceService) CreateVirtualMachineRestore(ctx context.Context, req *pb.CreateVirtualMachineRestoreRequest) (*pb.VirtualMachine_Restore, error) {
	restore, err := s.instance.CreateVirtualMachineRestore(ctx, req.GetScope(), req.GetNamespace(), req.GetName(), req.GetVirtualMachineName(), req.GetSnapshotName())
	if err != nil {
		return nil, err
	}
...
func (s *InstanceService) DeleteVirtualMachineRestore(ctx context.Context, req *pb.DeleteVirtualMachineRestoreRequest) (*emptypb.Empty, error) {
	if err := s.instance.DeleteVirtualMachineRestore(ctx, req.GetScope(), req.GetNamespace(), req.GetName()); err != nil {
		return nil, err
	}
	resp := &emptypb.Empty{}
	return resp, nil
...
func (s *InstanceService) StartVirtualMachine(ctx context.Context, req *pb.StartVirtualMachineRequest) (*emptypb.Empty, error) {
	if err := s.instance.StartVirtualMachine(ctx, req.GetScope(), req.GetNamespace(), req.GetName()); err != nil {
		return nil, err
	}
	resp := &emptypb.Empty{}
	return resp, nil
...
func (s *InstanceService) StopVirtualMachine(ctx context.Context, req *pb.StopVirtualMachineRequest) (*emptypb.Empty, error) {
	if err := s.instance.StopVirtualMachine(ctx, req.GetScope(), req.GetNamespace(), req.GetName()); err != nil {
		return nil, err
	}
	resp := &emptypb.Empty{}
	return resp, nil
...
func (s *InstanceService) RestartVirtualMachine(ctx context.Context, req *pb.RestartVirtualMachineRequest) (*emptypb.Empty, error) {
	if err := s.instance.RestartVirtualMachine(ctx, req.GetScope(), req.GetNamespace(), req.GetName()); err != nil {
		return nil, err
	}
	resp := &emptypb.Empty{}
	return resp, nil
...
func (s *InstanceService) PauseInstance(ctx context.Context, req *pb.PauseInstanceRequest) (*emptypb.Empty, error) {
	if err := s.instance.PauseInstance(ctx, req.GetScope(), req.GetNamespace(), req.GetName()); err != nil {
		return nil, err
	}
	resp := &emptypb.Empty{}
	return resp, nil
...
func (s *InstanceService) ResumeInstance(ctx context.Context, req *pb.ResumeInstanceRequest) (*emptypb.Empty, error) {
	if err := s.instance.ResumeInstance(ctx, req.GetScope(), req.GetNamespace(), req.GetName()); err != nil {
		return nil, err
	}
	resp := &emptypb.Empty{}
	return resp, nil
...
func (s *InstanceService) MigrateInstance(ctx context.Context, req *pb.MigrateInstanceRequest) (*emptypb.Empty, error) {
	if err := s.instance.MigrateInstance(ctx, req.GetScope(), req.GetNamespace(), req.GetName(), req.GetHostname()); err != nil {
		return nil, err
	}
	resp := &emptypb.Empty{}
	return resp, nil
...
func (s *InstanceService) VNCInstance(ctx context.Context, req *pb.VNCInstanceRequest) (*pb.VNCInstanceResponse, error) {
	sessionID, err := s.instance.CreateVNCSession(ctx, req.GetScope(), req.GetNamespace(), req.GetName())
	if err != nil {
		return nil, err
	}
...
func (s *InstanceService) ListDataVolumes(ctx context.Context, req *pb.ListDataVolumesRequest) (*pb.ListDataVolumesResponse, error) {
	its, err := s.instance.ListDataVolumes(ctx, req.GetScope(), req.GetNamespace(), req.GetBootImage())
	if err != nil {
		return nil, err
	}
...
func (s *InstanceService) GetDataVolume(ctx context.Context, req *pb.GetDataVolumeRequest) (*pb.DataVolume, error) {
	it, err := s.instance.GetDataVolume(ctx, req.GetScope(), req.GetNamespace(), req.GetName())
	if err != nil {
		return nil, err
	}
...
func (s *InstanceService) CreateDataVolume(ctx context.Context, req *pb.CreateDataVolumeRequest) (*pb.DataVolume, error) {
	src := req.GetSource()
	it, err := s.instance.CreateDataVolume(ctx, req.GetScope(), req.GetNamespace(), req.GetName(), core.DataVolumeSourceType(src.GetType()), src.GetData(), req.GetSizeBytes(), req.GetBootImage())
	if err != nil {
		return nil, err
	}
	resp := toProtoDataVolume(it)
...
func (s *InstanceService) DeleteDataVolume(ctx context.Context, req *pb.DeleteDataVolumeRequest) (*emptypb.Empty, error) {
	if err := s.instance.DeleteDataVolume(ctx, req.GetScope(), req.GetNamespace(), req.GetName()); err != nil {
		return nil, err
	}
	resp := &emptypb.Empty{}
	return resp, nil
...
func (s *InstanceService) ExtendDataVolume(ctx context.Context, req *pb.ExtendDataVolumeRequest) (*emptypb.Empty, error) {
	if err := s.instance.ExtendDataVolume(ctx, req.GetScope(), req.GetNamespace(), req.GetName(), req.GetSizeBytes()); err != nil {
		return nil, err
	}
	resp := &emptypb.Empty{}
	return resp, nil
...
func (s *InstanceService) ListInstanceTypes(ctx context.Context, req *pb.ListInstanceTypesRequest) (*pb.ListInstanceTypesResponse, error) {
	its, err := s.instance.ListInstanceTypes(ctx, req.GetScope(), req.GetNamespace(), req.GetIncludeClusterWide())
	if err != nil {
		return nil, err
	}
...
func (s *InstanceService) GetInstanceType(ctx context.Context, req *pb.GetInstanceTypeRequest) (*pb.InstanceType, error) {
	it, err := s.instance.GetInstanceType(ctx, req.GetScope(), req.GetNamespace(), req.GetName())
	if err != nil {
		return nil, err
	}
...
func (s *InstanceService) CreateInstanceType(ctx context.Context, req *pb.CreateInstanceTypeRequest) (*pb.InstanceType, error) {
	it, err := s.instance.CreateInstanceType(ctx, req.GetScope(), req.GetNamespace(), req.GetName(), req.GetCpuCores(), req.GetMemoryBytes())
	if err != nil {
		return nil, err
	}
	resp := toProtoInstanceType(it)
...
func (s *InstanceService) DeleteInstanceType(ctx context.Context, req *pb.DeleteInstanceTypeRequest) (*emptypb.Empty, error) {
	if err := s.instance.DeleteInstanceType(ctx, req.GetScope(), req.GetNamespace(), req.GetName()); err != nil {
		return nil, err
	}
	resp := &emptypb.Empty{}
	return resp, nil
...
func (s *InstanceService) CreateVirtualMachineService(ctx context.Context, req *pb.CreateVirtualMachineServiceRequest) (*apppb.Application_Service, error) {
	svc, err := s.instance.CreateVirtualMachineService(ctx, req.GetScope(), req.GetNamespace(), req.GetName(), req.GetVirtualMachineName(), toPorts(req.GetPorts()))
	if err != nil {
		return nil, err
	}
...
func (s *InstanceService) UpdateVirtualMachineService(ctx context.Context, req *pb.UpdateVirtualMachineServiceRequest) (*apppb.Application_Service, error) {
	svc, err := s.instance.UpdateVirtualMachineService(ctx, req.GetScope(), req.GetNamespace(), req.GetName(), toPorts(req.GetPorts()))
	if err != nil {
		return nil, err
	}
	resp := toProtoService(svc)
...
func (s *InstanceService) DeleteVirtualMachineService(ctx context.Context, req *pb.DeleteVirtualMachineServiceRequest) (*emptypb.Empty, error) {
	if err := s.instance.DeleteVirtualMachineService(ctx, req.GetScope(), req.GetNamespace(), req.GetName()); err != nil {
		return nil, err
	}
	resp := &emptypb.Empty{}
	return resp, nil
