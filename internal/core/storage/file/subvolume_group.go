...
func (uc *UseCase) ListSubvolumeGroups(ctx context.Context, scope, volume string) ([]SubvolumeGroup, error) {
	return uc.subvolumeGroup.List(ctx, scope, volume)
}

func (uc *UseCase) CreateSubvolumeGroup(ctx context.Context, scope, volume, group string, size uint64) (*SubvolumeGroup, error) {
...
func (uc *UseCase) UpdateSubvolumeGroup(ctx context.Context, scope, volume, group string, size uint64) (*SubvolumeGroup, error) {
...
func (uc *UseCase) DeleteSubvolumeGroup(ctx context.Context, scope, volume, group string) error {
