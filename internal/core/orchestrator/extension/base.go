			...
			Charts: []chartManifest{
				{
					...
					ValuesMap: map[string]string{
						"prometheus.prometheusSpec.externalLabels.juju_model":                                       "relace_scope_name",
						"prometheus.prometheusSpec.externalLabels.juju_model_uuid":                                  "relace_scope_uuid",
						"prometheus.prometheusSpec.enableRemoteWriteReceiver":                                       true,
						"prometheus.prometheusSpec.retention":                                                       "365d",
						"prometheus.prometheusSpec.retentionSize":                                                   "95GiB",
						"prometheus.prometheusSpec.storageSpec.volumeClaimTemplate.spec.storageClassName":           "replace_storage_class",
						...
						"grafana.defaultDashboardsTimezone":                                                         "Asia/Taipei",
						"grafana.defaultDashboardsEditable":                                                         true,
						"grafana.adminUser":                                                                         "admin",
						"grafana.adminPassword":                                                                     "admin",
						"grafana.persistence.enabled":                                                               true,
						"grafana.persistence.type":                                                                  "sts",
						"grafana.persistence.storageClassName":                                                      "replace_storage_class",
						"grafana.persistence.accessModes[0]":                                                        "ReadWriteOnce",
						"grafana.persistence.size":                                                                  "20Gi",
						"grafana.persistence.finalizers[0]":                                                         "kubernetes.io/pvc-protection",
					},
				},
			},
		},
