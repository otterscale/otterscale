...
var (
	kubernetesCharms = []EssentialCharm{
		{Name: "ch:kubernetes-control-plane", Channel: "1.32/stable", Machine: true},
		{Name: "ch:etcd", Channel: "1.32/stable", LXD: true},
		{Name: "ch:easyrsa", Channel: "1.32/stable", LXD: true},
		{Name: "ch:kubeapi-load-balancer", Channel: "1.32/stable", LXD: true},
		{Name: "ch:calico", Channel: "1.32/stable", Subordinate: true},
		{Name: "ch:containerd", Channel: "1.32/stable", Subordinate: true},
		{Name: "ch:keepalived", Channel: "1.32/stable", Subordinate: true},
	}
