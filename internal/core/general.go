...
func NewGeneralUseCase() *GeneralUseCase {
...
// func (uc *NexusService) isDeployedMachineExists(ctx context.Context, scopeUUID string) ([]model.Error, error) {
...
// func (uc *NexusService) listStatusMessage(ctx context.Context, scopeUUID string, facilityList []generalFacility, code string) ([]model.Error, error) {
