...
<Card.Root class="col-span-1 h-full w-full border-none bg-muted/40 shadow-none">
	<Card.Header class="h-[150px]">
		<Card.Title class="flex">
			<h1 class="text-nowrap text-3xl">Network</h1>
			<HoverCard.Root>
				<HoverCard.Trigger>
				...
				>
					<div class="flex items-center gap-2">
						<Badge variant="outline" class="w-fit">network load</Badge>
						<p>Total send/receive network load across all hosts in the ceph cluster</p>
					</div>
				</HoverCard.Content>
			</HoverCard.Root>
		</Card.Title>
