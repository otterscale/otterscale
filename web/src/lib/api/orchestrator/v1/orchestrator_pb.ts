...
export enum Extension_Type {
  ...
  /**
   * @generated from enum value: REGISTRY = 2;
   */
  REGISTRY = 2,

  /**
   * @generated from enum value: MODEL = 3;
   */
  MODEL = 3,
