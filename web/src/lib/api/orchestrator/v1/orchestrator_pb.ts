...
// @generated from file api/orchestrator/v1/orchestrator.proto (package otterscale.orchestrator.v1, edition 2024)
/* eslint-disable */
...
/**
 * @generated from message otterscale.orchestrator.v1.InstallPluginsRequest
 */
export type InstallPluginsRequest = Message<"otterscale.orchestrator.v1.InstallPluginsRequest"> & {
  /**
   * @generated from field: string scope = 1;
   */
  scope: string;
  ...
  /**
   * @generated from field: repeated otterscale.orchestrator.v1.Plugin.Chart charts = 3;
   */
  charts: Plugin_Chart[];
};

/**
 * Describes the message otterscale.orchestrator.v1.InstallPluginsRequest.
 * Use `create(InstallPluginsRequestSchema)` to create a new message.
 */
export const InstallPluginsRequestSchema: GenMessage<InstallPluginsRequest> = /*@__PURE__*/
  messageDesc(file_api_orchestrator_v1_orchestrator, 24);

/**
 * @generated from message otterscale.orchestrator.v1.UpgradePluginsRequest
 */
export type UpgradePluginsRequest = Message<"otterscale.orchestrator.v1.UpgradePluginsRequest"> & {
  /**
   * @generated from field: string scope = 1;
   */
  scope: string;
...
/**
 * Describes the message otterscale.orchestrator.v1.UpgradePluginsRequest.
 * Use `create(UpgradePluginsRequestSchema)` to create a new message.
 */
export const UpgradePluginsRequestSchema: GenMessage<UpgradePluginsRequest> = /*@__PURE__*/
...
export const OrchestratorService: GenService<{
  ...
  /**
   * @generated from rpc otterscale.orchestrator.v1.OrchestratorService.InstallPlugins
   */
  installPlugins: {
    methodKind: "unary";
    input: typeof InstallPluginsRequestSchema;
    output: typeof EmptySchema;
  },
  /**
   * @generated from rpc otterscale.orchestrator.v1.OrchestratorService.UpgradePlugins
   */
  upgradePlugins: {
    methodKind: "unary";
    input: typeof UpgradePluginsRequestSchema;
    output: typeof EmptySchema;
  },
}> = /*@__PURE__*/
