...
<Card.Root class="relative h-full min-h-[140px] gap-2 overflow-hidden">
	...
	<Card.Header>
		...
		<Card.Description class="flex h-6 items-center">Control Nodes and Worker Nodes</Card.Description>
	</Card.Header>
	{#if !isLoaded}
	...
	{:else}
		<Card.Content class="text-3xl">{clusterNodes?.value ?? 'N/A'}</Card.Content>
	{/if}
</Card.Root>