		...
		<Card.Content class="flex items-center justify-between gap-4">
			<div class="flex gap-8">
				<div class="flex flex-col">
					...
					<span class="text-1xl font-medium text-muted-foreground uppercase tracking-wider">Total NVIDIA GPUs</span>
				</div>
				<div class="flex flex-col">
					<span class="text-3xl font-bold">{avgGpuTemperature ? Math.round(Number(avgGpuTemperature.value)) : 'N/A'}°C</span>
					<span class="text-1xl font-medium text-muted-foreground uppercase tracking-wider">Average Temperature</span>
				</div>
			</div>
