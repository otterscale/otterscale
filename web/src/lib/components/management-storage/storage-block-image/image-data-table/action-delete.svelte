<script lang="ts" module>
	...
	import { type Request } from './image-create.svelte';
...
<AlertDialog.Root bind:open={stateController.state}>
	...
	<AlertDialog.Content>
		...
		<Form.Root>
			<Form.Fieldset>
				<Form.Help>
					Please type the block device name exactly to confirm deletion. This action cannot be
					undone.
				</Form.Help>
				<Form.Field>
					<SingleInput.DeletionConfirm
						required
						id="rados-block-device-delete"
						target={blockImage.name}
