...
func (h *Helper) Select(ctx context.Context, tx pgx.Tx, mode property.SyncMode, curs []*workload.Sync_Option_Cursor) (pgx.Rows, error) {
	return tx.Query(ctx, selectStatement(h.tableName, h.sch, mode, curs))
}
