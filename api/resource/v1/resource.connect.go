...
func NewResourceServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ResourceServiceClient {
	...
	resourceServiceMethods := File_resource_v1_resource_proto.Services().ByName("ResourceService").Methods()
	return &resourceServiceClient{
		discovery: connect.NewClient[DiscoveryRequest, DiscoveryResponse](
			httpClient,
		...
		watch: connect.NewClient[WatchRequest, WatchEvent](
			httpClient,
...
func (c *resourceServiceClient) Discovery(ctx context.Context, req *DiscoveryRequest) (*DiscoveryResponse, error) {
...
func (c *resourceServiceClient) List(ctx context.Context, req *ListRequest) (*ListResponse, error) {
...
func (c *resourceServiceClient) Get(ctx context.Context, req *GetRequest) (*Resource, error) {
...
func (c *resourceServiceClient) Describe(ctx context.Context, req *DescribeRequest) (*DescribeResponse, error) {
...
func (c *resourceServiceClient) Create(ctx context.Context, req *CreateRequest) (*Resource, error) {
...
func (c *resourceServiceClient) Apply(ctx context.Context, req *ApplyRequest) (*Resource, error) {
...
func (c *resourceServiceClient) Watch(ctx context.Context, req *WatchRequest) (*connect.ServerStreamForClient[WatchEvent], error) {
...
func (UnimplementedResourceServiceHandler) Discovery(context.Context, *DiscoveryRequest) (*DiscoveryResponse, error) {
...
func (UnimplementedResourceServiceHandler) Get(context.Context, *GetRequest) (*Resource, error) {
...
func (UnimplementedResourceServiceHandler) Describe(context.Context, *DescribeRequest) (*DescribeResponse, error) {
...
func (UnimplementedResourceServiceHandler) Create(context.Context, *CreateRequest) (*Resource, error) {
...
func (UnimplementedResourceServiceHandler) Watch(context.Context, *WatchRequest, *connect.ServerStream[WatchEvent]) error {
