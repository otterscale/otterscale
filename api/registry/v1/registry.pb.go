...
type ImportChartRequest struct {
	state                  protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_ChartRef    *string                `protobuf:"bytes,1,opt,name=chart_ref,json=chartRef"`
	xxx_hidden_RegistryUrl *string                `protobuf:"bytes,2,opt,name=registry_url,json=registryUrl"`
	XXX_raceDetectHookData protoimpl.RaceDetectHookData
	XXX_presence           [1]uint32
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
...
func (x *ImportChartRequest) Reset() {
	*x = ImportChartRequest{}
	mi := &file_api_registry_v1_registry_proto_msgTypes[17]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ImportChartRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ImportChartRequest) ProtoMessage() {}

func (x *ImportChartRequest) ProtoReflect() protoreflect.Message {
	mi := &file_api_registry_v1_registry_proto_msgTypes[17]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
func (x *ImportChartRequest) GetChartRef() string {
	if x != nil {
		if x.xxx_hidden_ChartRef != nil {
			return *x.xxx_hidden_ChartRef
		}
...
func (x *ImportChartRequest) GetRegistryUrl() string {
	if x != nil {
		if x.xxx_hidden_RegistryUrl != nil {
			return *x.xxx_hidden_RegistryUrl
		}
...
func (x *ImportChartRequest) SetChartRef(v string) {
	x.xxx_hidden_ChartRef = &v
	protoimpl.X.SetPresent(&(x.XXX_presence[0]), 0, 2)
}

func (x *ImportChartRequest) SetRegistryUrl(v string) {
	x.xxx_hidden_RegistryUrl = &v
	protoimpl.X.SetPresent(&(x.XXX_presence[0]), 1, 2)
}

func (x *ImportChartRequest) HasChartRef() bool {
	if x == nil {
		return false
	}
	return protoimpl.X.Present(&(x.XXX_presence[0]), 0)
...
func (x *ImportChartRequest) HasRegistryUrl() bool {
	if x == nil {
		return false
	}
	return protoimpl.X.Present(&(x.XXX_presence[0]), 1)
...
func (x *ImportChartRequest) ClearChartRef() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 0)
	x.xxx_hidden_ChartRef = nil
}

func (x *ImportChartRequest) ClearRegistryUrl() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 1)
	x.xxx_hidden_RegistryUrl = nil
}

type ImportChartRequest_builder struct {
	_ [0]func() // Prevents comparability and use of unkeyed literals for the builder.
...
func (b0 ImportChartRequest_builder) Build() *ImportChartRequest {
	m0 := &ImportChartRequest{}
	b, x := &b0, m0
	_, _ = b, x
	if b.ChartRef != nil {
		protoimpl.X.SetPresentNonAtomic(&(x.XXX_presence[0]), 0, 2)
...
func (x *Chart_Dependency) Reset() {
	*x = Chart_Dependency{}
	mi := &file_api_registry_v1_registry_proto_msgTypes[25]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
const file_api_registry_v1_registry_proto_rawDesc = "" +
	...
	"\fregistry_url\x18\x01 \x01(\tR\vregistryUrl\"T\n" +
	"\x12ImportChartRequest\x12\x1b\n" +
	"\tchart_ref\x18\x01 \x01(\tR\bchartRef\x12!\n" +
	"\fregistry_url\x18\x02 \x01(\tR\vregistryUrl2\xa9\t\n" +
	...
	"\x10registry-enabled\x12j\n" +
	"\vImportChart\x12*.otterscale.registry.v1.ImportChartRequest\x1a\x16.google.protobuf.Empty\"\x17\x8a\xdf\xd5\x1d\x12\n" +
	"\x10registry-enabledB5Z3github.com/otterscale/otterscale/api/registry/v1;pbb\beditionsp\xe8\a"

var file_api_registry_v1_registry_proto_msgTypes = make([]protoimpl.MessageInfo, 27)
var file_api_registry_v1_registry_proto_goTypes = []any{
	...
	(*ImportChartRequest)(nil),         // 17: otterscale.registry.v1.ImportChartRequest
	(*Image_Platform)(nil),             // 18: otterscale.registry.v1.Image.Platform
	(*Image_Config)(nil),               // 19: otterscale.registry.v1.Image.Config
	(*Image_RootFS)(nil),               // 20: otterscale.registry.v1.Image.RootFS
	nil,                                // 21: otterscale.registry.v1.Image.Config.LabelsEntry
	(*Chart_Information)(nil),          // 22: otterscale.registry.v1.Chart.Information
	(*Chart_Version)(nil),              // 23: otterscale.registry.v1.Chart.Version
	(*Chart_Maintainer)(nil),           // 24: otterscale.registry.v1.Chart.Maintainer
	(*Chart_Dependency)(nil),           // 25: otterscale.registry.v1.Chart.Dependency
	nil,                                // 26: otterscale.registry.v1.Chart.AnnotationsEntry
...
var file_api_registry_v1_registry_proto_depIdxs = []int32{
	...
	27, // 2: otterscale.registry.v1.Image.created_at:type_name -> google.protobuf.Timestamp
	18, // 3: otterscale.registry.v1.Image.platform:type_name -> otterscale.registry.v1.Image.Platform
	19, // 4: otterscale.registry.v1.Image.config:type_name -> otterscale.registry.v1.Image.Config
	20, // 5: otterscale.registry.v1.Image.root_fs:type_name -> otterscale.registry.v1.Image.RootFS
	24, // 6: otterscale.registry.v1.Chart.maintainers:type_name -> otterscale.registry.v1.Chart.Maintainer
	26, // 7: otterscale.registry.v1.Chart.annotations:type_name -> otterscale.registry.v1.Chart.AnnotationsEntry
	25, // 8: otterscale.registry.v1.Chart.dependencies:type_name -> otterscale.registry.v1.Chart.Dependency
	...
	23, // 12: otterscale.registry.v1.ListChartVersionsResponse.versions:type_name -> otterscale.registry.v1.Chart.Version
	21, // 13: otterscale.registry.v1.Image.Config.labels:type_name -> otterscale.registry.v1.Image.Config.LabelsEntry
	...
	17, // 22: otterscale.registry.v1.RegistryService.ImportChart:input_type -> otterscale.registry.v1.ImportChartRequest
	5,  // 23: otterscale.registry.v1.RegistryService.GetRegistryURL:output_type -> otterscale.registry.v1.GetRegistryURLResponse
	7,  // 24: otterscale.registry.v1.RegistryService.ListRepositories:output_type -> otterscale.registry.v1.ListRepositoriesResponse
	9,  // 25: otterscale.registry.v1.RegistryService.ListManifests:output_type -> otterscale.registry.v1.ListManifestsResponse
	28, // 26: otterscale.registry.v1.RegistryService.DeleteManifest:output_type -> google.protobuf.Empty
	12, // 27: otterscale.registry.v1.RegistryService.ListCharts:output_type -> otterscale.registry.v1.ListChartsResponse
	14, // 28: otterscale.registry.v1.RegistryService.ListChartVersions:output_type -> otterscale.registry.v1.ListChartVersionsResponse
	22, // 29: otterscale.registry.v1.RegistryService.GetChartInformation:output_type -> otterscale.registry.v1.Chart.Information
	28, // 30: otterscale.registry.v1.RegistryService.SyncArtifactHub:output_type -> google.protobuf.Empty
	28, // 31: otterscale.registry.v1.RegistryService.ImportChart:output_type -> google.protobuf.Empty
