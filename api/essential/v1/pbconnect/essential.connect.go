...
type EssentialServiceClient interface {
	...
	GetGpuRelationByMachine(context.Context, *connect.Request[v1.GetGpuRelationRequest]) (*connect.Response[v1.GetGpuRelationByResponse], error)
	GetGpuRelationByModel(context.Context, *connect.Request[v1.GetGpuRelationRequest]) (*connect.Response[v1.GetGpuRelationByResponse], error)
}
...
func NewEssentialServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) EssentialServiceClient {
	...
	return &essentialServiceClient{
		...
		getGpuRelationByMachine: connect.NewClient[v1.GetGpuRelationRequest, v1.GetGpuRelationByResponse](
			httpClient,
		...
		getGpuRelationByModel: connect.NewClient[v1.GetGpuRelationRequest, v1.GetGpuRelationByResponse](
			httpClient,
...
type essentialServiceClient struct {
	...
	getGpuRelationByMachine       *connect.Client[v1.GetGpuRelationRequest, v1.GetGpuRelationByResponse]
	getGpuRelationByModel         *connect.Client[v1.GetGpuRelationRequest, v1.GetGpuRelationByResponse]
}
...
func (c *essentialServiceClient) GetGpuRelationByMachine(ctx context.Context, req *connect.Request[v1.GetGpuRelationRequest]) (*connect.Response[v1.GetGpuRelationByResponse], error) {
...
func (c *essentialServiceClient) GetGpuRelationByModel(ctx context.Context, req *connect.Request[v1.GetGpuRelationRequest]) (*connect.Response[v1.GetGpuRelationByResponse], error) {
...
func (UnimplementedEssentialServiceHandler) GetGpuRelationByMachine(context.Context, *connect.Request[v1.GetGpuRelationRequest]) (*connect.Response[v1.GetGpuRelationByResponse], error) {
...
func (UnimplementedEssentialServiceHandler) GetGpuRelationByModel(context.Context, *connect.Request[v1.GetGpuRelationRequest]) (*connect.Response[v1.GetGpuRelationByResponse], error) {
