...
const file_api_application_v1_application_proto_rawDesc = "" +
	"\n" +
	"$api/application/v1/application.proto\x12\x19otterscale.application.v1\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1cgoogle/protobuf/struct.proto\"\xf2\x19\n" +
	...
	"\x0fstorage_classes\x18\x01 \x03(\v2'.otterscale.application.v1.StorageClassR\x0estorageClasses2\x85\f\n" +
...
var file_api_application_v1_application_proto_msgTypes = make([]protoimpl.MessageInfo, 38)
var file_api_application_v1_application_proto_goTypes = []any{
	...
	(*ExecuteTTYRequest)(nil),                 // 7: otterscale.application.v1.ExecuteTTYRequest
	(*ExecuteTTYResponse)(nil),                // 8: otterscale.application.v1.ExecuteTTYResponse
	(*WriteTTYRequest)(nil),                   // 9: otterscale.application.v1.WriteTTYRequest
	...
	(*Application_Chart)(nil),                 // 22: otterscale.application.v1.Application.Chart
	(*Application_Release)(nil),               // 23: otterscale.application.v1.Application.Release
	(*Application_Condition)(nil),             // 24: otterscale.application.v1.Application.Condition
	(*Application_Container)(nil),             // 25: otterscale.application.v1.Application.Container
	(*Application_Service)(nil),               // 26: otterscale.application.v1.Application.Service
	(*Application_Pod)(nil),                   // 27: otterscale.application.v1.Application.Pod
	(*Application_PersistentVolumeClaim)(nil), // 28: otterscale.application.v1.Application.PersistentVolumeClaim
	nil,                                     // 29: otterscale.application.v1.Application.LabelsEntry
	(*Application_Chart_Customization)(nil), // 30: otterscale.application.v1.Application.Chart.Customization
	(*Application_Chart_Metadata)(nil),      // 31: otterscale.application.v1.Application.Chart.Metadata
	(*Application_Chart_Maintainer)(nil),    // 32: otterscale.application.v1.Application.Chart.Maintainer
	(*Application_Chart_Dependency)(nil),    // 33: otterscale.application.v1.Application.Chart.Dependency
	(*Application_Chart_Version)(nil),       // 34: otterscale.application.v1.Application.Chart.Version
	(*Application_Service_Port)(nil),        // 35: otterscale.application.v1.Application.Service.Port
	nil,                                     // 36: otterscale.application.v1.StorageClass.ParametersEntry
	nil,                                     // 37: otterscale.application.v1.CreateReleaseRequest.ValuesMapEntry
...
var file_api_application_v1_application_proto_depIdxs = []int32{
	29, // 0: otterscale.application.v1.Application.labels:type_name -> otterscale.application.v1.Application.LabelsEntry
	31, // 1: otterscale.application.v1.Application.metadata:type_name -> otterscale.application.v1.Application.Chart.Metadata
	25, // 2: otterscale.application.v1.Application.containers:type_name -> otterscale.application.v1.Application.Container
	26, // 3: otterscale.application.v1.Application.services:type_name -> otterscale.application.v1.Application.Service
	27, // 4: otterscale.application.v1.Application.pods:type_name -> otterscale.application.v1.Application.Pod
	28, // 5: otterscale.application.v1.Application.persistent_volume_claims:type_name -> otterscale.application.v1.Application.PersistentVolumeClaim
	38, // 6: otterscale.application.v1.Application.created_at:type_name -> google.protobuf.Timestamp
	36, // 7: otterscale.application.v1.StorageClass.parameters:type_name -> otterscale.application.v1.StorageClass.ParametersEntry
	38, // 8: otterscale.application.v1.StorageClass.created_at:type_name -> google.protobuf.Timestamp
	0,  // 9: otterscale.application.v1.ListApplicationsResponse.applications:type_name -> otterscale.application.v1.Application
	23, // 10: otterscale.application.v1.ListReleasesResponse.releases:type_name -> otterscale.application.v1.Application.Release
	37, // 11: otterscale.application.v1.CreateReleaseRequest.values_map:type_name -> otterscale.application.v1.CreateReleaseRequest.ValuesMapEntry
	22, // 12: otterscale.application.v1.ListChartsResponse.charts:type_name -> otterscale.application.v1.Application.Chart
	...
	32, // 14: otterscale.application.v1.Application.Chart.maintainers:type_name -> otterscale.application.v1.Application.Chart.Maintainer
	33, // 15: otterscale.application.v1.Application.Chart.dependencies:type_name -> otterscale.application.v1.Application.Chart.Dependency
	34, // 16: otterscale.application.v1.Application.Chart.versions:type_name -> otterscale.application.v1.Application.Chart.Version
	34, // 17: otterscale.application.v1.Application.Release.version:type_name -> otterscale.application.v1.Application.Chart.Version
	38, // 18: otterscale.application.v1.Application.Condition.probed_at:type_name -> google.protobuf.Timestamp
	38, // 19: otterscale.application.v1.Application.Condition.transitioned_at:type_name -> google.protobuf.Timestamp
	35, // 20: otterscale.application.v1.Application.Service.ports:type_name -> otterscale.application.v1.Application.Service.Port
	38, // 21: otterscale.application.v1.Application.Service.created_at:type_name -> google.protobuf.Timestamp
	24, // 22: otterscale.application.v1.Application.Pod.last_condition:type_name -> otterscale.application.v1.Application.Condition
	38, // 23: otterscale.application.v1.Application.Pod.created_at:type_name -> google.protobuf.Timestamp
	...
	38, // 25: otterscale.application.v1.Application.PersistentVolumeClaim.created_at:type_name -> google.protobuf.Timestamp
	39, // 26: otterscale.application.v1.Application.Chart.Customization.values:type_name -> google.protobuf.Struct
	30, // 27: otterscale.application.v1.Application.Chart.Metadata.customization:type_name -> otterscale.application.v1.Application.Chart.Customization
	...
	7,  // 31: otterscale.application.v1.ApplicationService.ExecuteTTY:input_type -> otterscale.application.v1.ExecuteTTYRequest
	9,  // 32: otterscale.application.v1.ApplicationService.WriteTTY:input_type -> otterscale.application.v1.WriteTTYRequest
	10, // 33: otterscale.application.v1.ApplicationService.ListReleases:input_type -> otterscale.application.v1.ListReleasesRequest
	12, // 34: otterscale.application.v1.ApplicationService.CreateRelease:input_type -> otterscale.application.v1.CreateReleaseRequest
	13, // 35: otterscale.application.v1.ApplicationService.UpdateRelease:input_type -> otterscale.application.v1.UpdateReleaseRequest
	14, // 36: otterscale.application.v1.ApplicationService.DeleteRelease:input_type -> otterscale.application.v1.DeleteReleaseRequest
	15, // 37: otterscale.application.v1.ApplicationService.RollbackRelease:input_type -> otterscale.application.v1.RollbackReleaseRequest
	16, // 38: otterscale.application.v1.ApplicationService.ListCharts:input_type -> otterscale.application.v1.ListChartsRequest
	18, // 39: otterscale.application.v1.ApplicationService.GetChart:input_type -> otterscale.application.v1.GetChartRequest
	19, // 40: otterscale.application.v1.ApplicationService.GetChartMetadata:input_type -> otterscale.application.v1.GetChartMetadataRequest
	20, // 41: otterscale.application.v1.ApplicationService.ListStorageClasses:input_type -> otterscale.application.v1.ListStorageClassesRequest
	3,  // 42: otterscale.application.v1.ApplicationService.ListApplications:output_type -> otterscale.application.v1.ListApplicationsResponse
	0,  // 43: otterscale.application.v1.ApplicationService.GetApplication:output_type -> otterscale.application.v1.Application
	6,  // 44: otterscale.application.v1.ApplicationService.WatchLogs:output_type -> otterscale.application.v1.WatchLogsResponse
	8,  // 45: otterscale.application.v1.ApplicationService.ExecuteTTY:output_type -> otterscale.application.v1.ExecuteTTYResponse
	40, // 46: otterscale.application.v1.ApplicationService.WriteTTY:output_type -> google.protobuf.Empty
	11, // 47: otterscale.application.v1.ApplicationService.ListReleases:output_type -> otterscale.application.v1.ListReleasesResponse
	23, // 48: otterscale.application.v1.ApplicationService.CreateRelease:output_type -> otterscale.application.v1.Application.Release
	23, // 49: otterscale.application.v1.ApplicationService.UpdateRelease:output_type -> otterscale.application.v1.Application.Release
	40, // 50: otterscale.application.v1.ApplicationService.DeleteRelease:output_type -> google.protobuf.Empty
	40, // 51: otterscale.application.v1.ApplicationService.RollbackRelease:output_type -> google.protobuf.Empty
	17, // 52: otterscale.application.v1.ApplicationService.ListCharts:output_type -> otterscale.application.v1.ListChartsResponse
	22, // 53: otterscale.application.v1.ApplicationService.GetChart:output_type -> otterscale.application.v1.Application.Chart
	31, // 54: otterscale.application.v1.ApplicationService.GetChartMetadata:output_type -> otterscale.application.v1.Application.Chart.Metadata
	21, // 55: otterscale.application.v1.ApplicationService.ListStorageClasses:output_type -> otterscale.application.v1.ListStorageClassesResponse
