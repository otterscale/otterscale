...
const file_api_machine_v1_machine_proto_rawDesc = "" +
	"\n" +
	"\x1capi/machine/v1/machine.proto\x12\x15otterscale.machine.v1\x1a\x1bgoogle/protobuf/empty.proto\"\x92\x10\n" +
	"\aMachine\x12\x0e\n" +
...
var file_api_machine_v1_machine_proto_depIdxs = []int32{
	12, // 0: otterscale.machine.v1.Machine.workload_annotations:type_name -> otterscale.machine.v1.Machine.WorkloadAnnotationsEntry
	13, // 1: otterscale.machine.v1.Machine.hardware_information:type_name -> otterscale.machine.v1.Machine.HardwareInformationEntry
	9,  // 2: otterscale.machine.v1.Machine.numa_nodes:type_name -> otterscale.machine.v1.Machine.NUMANode
	10, // 3: otterscale.machine.v1.Machine.block_devices:type_name -> otterscale.machine.v1.Machine.BlockDevice
	11, // 4: otterscale.machine.v1.Machine.network_interfaces:type_name -> otterscale.machine.v1.Machine.NetworkInterface
	0,  // 5: otterscale.machine.v1.ListMachinesResponse.machines:type_name -> otterscale.machine.v1.Machine
	1,  // 6: otterscale.machine.v1.MachineService.ListMachines:input_type -> otterscale.machine.v1.ListMachinesRequest
	3,  // 7: otterscale.machine.v1.MachineService.GetMachine:input_type -> otterscale.machine.v1.GetMachineRequest
	4,  // 8: otterscale.machine.v1.MachineService.CreateMachine:input_type -> otterscale.machine.v1.CreateMachineRequest
	5,  // 9: otterscale.machine.v1.MachineService.DeleteMachine:input_type -> otterscale.machine.v1.DeleteMachineRequest
	6,  // 10: otterscale.machine.v1.MachineService.PowerOffMachine:input_type -> otterscale.machine.v1.PowerOffMachineRequest
	7,  // 11: otterscale.machine.v1.MachineService.AddMachineTags:input_type -> otterscale.machine.v1.AddMachineTagsRequest
	8,  // 12: otterscale.machine.v1.MachineService.RemoveMachineTags:input_type -> otterscale.machine.v1.RemoveMachineTagsRequest
	2,  // 13: otterscale.machine.v1.MachineService.ListMachines:output_type -> otterscale.machine.v1.ListMachinesResponse
	0,  // 14: otterscale.machine.v1.MachineService.GetMachine:output_type -> otterscale.machine.v1.Machine
	0,  // 15: otterscale.machine.v1.MachineService.CreateMachine:output_type -> otterscale.machine.v1.Machine
	14, // 16: otterscale.machine.v1.MachineService.DeleteMachine:output_type -> google.protobuf.Empty
	0,  // 17: otterscale.machine.v1.MachineService.PowerOffMachine:output_type -> otterscale.machine.v1.Machine
	14, // 18: otterscale.machine.v1.MachineService.AddMachineTags:output_type -> google.protobuf.Empty
	14, // 19: otterscale.machine.v1.MachineService.RemoveMachineTags:output_type -> google.protobuf.Empty
