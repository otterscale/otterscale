...
- [x] [v1.0.0](https://github.com/openhdc/otterscale/milestone/1): MAAS, Juju, Ceph, Kubernetes, Helm, Go, Svelte, ConnectRPC
- [ ] [v1.1.0](https://github.com/openhdc/otterscale/milestone/2): Virtual Machine, GPU Operator, Open Policy Agent
- [ ] [v1.2.0](https://github.com/openhdc/otterscale/milestone/3): Helm Upload, API Interface, AI Agent
