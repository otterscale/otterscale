...
> This repository houses the user interface for OtterScale, which has been split from the `otterscale-legacy` project.
>
> The core application can be found in the `otterscale` repository.
