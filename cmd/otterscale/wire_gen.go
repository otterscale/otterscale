...
func wireCmd(bool2 bool) (*cobra.Command, func(), error) {
	...
	bistUseCase := core.NewBISTUseCase(actionRepo, scopeRepo, kubeBatchRepo, kubeAppsRepo, kubeCoreRepo, kubeStorageRepo, facilityRepo, configConfig, clientRepo)
	...
	bistService := app.NewBISTService(bistUseCase, storageUseCase)
