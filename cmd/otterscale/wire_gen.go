...
func wireCmd(bool2 bool) (*cobra.Command, func(), error) {
	...
	kubeSMBRepo := kube.NewSMB(kubeKube)
	storageUseCase := core.NewStorageUseCase(actionRepo, facilityRepo, cephClusterRepo, cephFSRepo, cephRBDRepo, cephRGWRepo, machineRepo, kubeCoreRepo, kubeAppsRepo, kubeSMBRepo)
