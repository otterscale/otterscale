...
func wireCmd(bool2 bool) (*cobra.Command, func(), error) {
	...
	essentialUseCase := core.NewEssentialUseCase(configConfig, kubeCoreRepo, kubeAppsRepo, actionRepo, scopeRepo, facilityRepo, facilityOffersRepo, machineRepo, subnetRepo, ipRangeRepo, serverRepo, clientRepo, tagRepo)
