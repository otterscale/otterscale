...
func wireCmd(bool2 bool) (*cobra.Command, func(), error) {
	...
	workloadUseCase := workload.NewUseCase(daemonSetRepo, deploymentRepo, jobRepo, podRepo, statefulSetRepo, serviceRepo, nodeRepo, persistentVolumeClaimRepo, storageClassRepo)
	...
	bistUseCase := bist.NewUseCase(configConfig, bucketRepo, configMapRepo, imageRepo, jobRepo, namespaceRepo, nodeRepo, storageNodeRepo, podRepo, poolRepo, secretRepo, serviceRepo)
