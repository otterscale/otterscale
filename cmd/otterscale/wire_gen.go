...
func wireCmd(bool2 bool) (*cobra.Command, func(), error) {
	...
	vmUseCase := vm.NewUseCase(virtualMachineRepo, virtualMachineCloneRepo, virtualMachineRestoreRepo, virtualMachineSnapshotRepo, machineRepo, serviceRepo, virtualMachineInstanceRepo, virtualMachineInstanceTypeRepo)
