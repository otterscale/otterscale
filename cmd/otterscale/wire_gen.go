...
func wireCmd() (*cobra.Command, func(), error) {
	...
	generalUseCase := core.NewGeneralUseCase()
	generalService := app.NewGeneralService(generalUseCase)
	...
	serveMux := mux.New(applicationService, configurationService, facilityService, generalService, machineService, networkService, scopeService, tagService)
