...
func wireCmd(bool2 bool) (*cobra.Command, func(), error) {
	...
	facilityUseCase := core.NewFacilityUseCase(facilityRepo, serverRepo, clientRepo, actionRepo, charmRepo, machineRepo, tagRepo)
	...
	essentialUseCase := core.NewEssentialUseCase(configConfig, scopeRepo, facilityRepo, facilityOffersRepo, machineRepo, subnetRepo, ipRangeRepo, serverRepo, clientRepo, tagRepo)
